    ...
    <div className="space-y-3">
          ...
          <div className="grid gap-3 p-4 md:grid-cols-[1.2fr_1fr]">
            <div>
              ...
              <p className="text-[12.5px] leading-relaxed text-text-secondary">
                VN-INDEX · VN30 · HNX-INDEX · UPCOM-INDEX cần nguồn VN. Market Condition Engine vẫn chạy với các cấu phần sẵn có.
              </p>
      ...
      >
        {intel.contributors.positive.length + intel.contributors.negative.length === 0 ? (
          <div className="p-4">
            <Unavailable title="Chưa có dữ liệu cấu phần chỉ số" />
          </div>
        ) : (
