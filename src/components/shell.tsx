              ...
              {section.items.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {!collapsed && item.core && (
                      <span className="ml-auto rounded border border-accent-primary/40 bg-accent-primary/10 px-1 text-[8.5px] font-bold tracking-wider text-accent-primary">CỐT LÕI</span>
                    )}
                  </Link>
                );
              })}
    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 z-50 mt-1.5 w-[min(20rem,calc(100vw-1rem))] overflow-hidden rounded-xl border border-border-default bg-surface-modal shadow-2xl">
          ...
          {!enabled ? (
            <p className="px-3 py-3 text-[12px] text-text-muted">Thông báo tin tức đang tắt — bật lại trong Cài đặt › Thông báo.</p>
